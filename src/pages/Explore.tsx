...
export default function Explore() {
  ...
  useSeoMeta({
    ...
    description: 'Browse trending queries from the 0xPresearchstr community search index, cached on Nostr.',
  });
    ...
    <Layout>
      <div className="container max-w-3xl py-10">
        ...
        <p className="text-xs text-muted-foreground/60 mt-8 leading-relaxed">
          ...
          indexer bots — 0xPresearchstr and 0xSearchstr share one federated index, so searches
